...
Функция ЕстьПрофилиСПравамиРасширения()
	...
	Иначе
		...
		Запрос.Текст = 
			...
			|////////////////////////////////////////////////////////////////////////////////
			|ВЫБРАТЬ
			|	ПрофилиГД.Ссылка КАК ПрофильГД,
			|	Профили.Ссылка КАК Профиль
			|ИЗ
			|	ПрофилиГД КАК ПрофилиГД
			|		ЛЕВОЕ СОЕДИНЕНИЕ Профили КАК Профили
			|		ПО ПрофилиГД.Ссылка = Профили.Ссылка
			|ГДЕ
...
// Проверяем наличие роли , а не право доступа к контретному объекту метаданных
